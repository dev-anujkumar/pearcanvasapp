let qaConfig = {
    ...
    CTOOL_PUBSLATE: 'https://qa.api.pearson.com/content/tools/wip2cite/publishslate/v1/',
    CTOOL_PUBTITLE:  'https://qa.api.pearson.com/content/tools/wip2cite/publishtitle/v1/',
