...
export const IMPORTING_TIPS_CONTENT_TEXT_THIRD = ': We support Word documents in'
export const IMPORTING_TIPS_CONTENT_TEXT_FOURTH = 'Style with Text Formatting'
export const IMPORTING_TIPS_CONTENT_TEXT_FIFTH = ': Consistently apply text styles, such as Headings, Lists and Normal Font Style, for an accurate import result.'
export const IMPORTING_TIPS_CONTENT_TEXT_SIXTH = 'Simplicity is Key:'
export const IMPORTING_TIPS_CONTENT_TEXT_SEVENTH = " Cypress doesn't support complex elements like Images, Charts, Smart-art, Shapes, Tables, Columns, Quotes or Nested Tables via import. Stick to supported elements for a smooth import."
