...
export const elmAssessmentText = 'Elm assessment'
export const approvedButtonText = 'approved-button'
export const applicationJsonText = 'application/json'
export const assetPopoverAttacherText = 'asset-popover-attacher'
export const blockquoteParagraphNummerEinsText = 'blockquote p.paragraphNummerEins'
export const cmDescriptionText = 'cm:description'
export const elementAsideText = 'element-aside'
export const pressShiftTabText = 'Press Shift+Tab to move out'
export const typeSomethingText = 'Type something...'
export const elementAuthoredText = 'element-authoredtext'
export const formattedTitleText = 'formatted-title'
export const primaryBlockquoteText = 'primary-blockquote'
export const primaryListText = 'primary-list'
export const secondaryImageFigureHalfText = 'secondary-image-figure-half'
export const primarySmartlinkText = 'primary-smartlink'
export const primaryAsideAsideText = 'primary-aside-aside'
export const asigneeSelectedText = 'asignee-selected'
export const transitionNoneText = 'transition-none'
export const floatingLabelText = 'floating-label'
export const floatingNumberText = 'floating-number'
export const elementLabelClass = '.element-label'
export const ignoreForDragClass = '.ignore-for-drag'
export const lazyloadWrapperClass = '.lazyload-wrapper'
export const institutionUrlsText = 'institution-urls'
export const avsJsonStringText = 'avs:jsonString'
export const formattedSubtitleText = 'formatted-subtitle'
export const urnPearsonAlfrescoText = 'urn:pearson:alfresco:'
export const dataMceStyleText = 'data-mce-style'
export const dataMceSelectedText = 'data-mce-selected'
export const imgWirisformulaClass = 'img.Wirisformula, img.temp_Wirisformula'
export const popupWebLinkText = 'pop-up-web-link'
export const previousSlateButtonText = 'previous-slate-button'
export const stopEventText = 'stop-event'
export const nextSlateButtonText = 'next-slate-button'
export const multipleElementClasses = '.power-paste-icon,.split-icon, .delete-icon,.popup-button,.element-label'
export const elementAssessmentText = 'element-assessment'
export const cplgAltText = 'cplg:altText'
export const cplgLongDescriptionText = 'cplg:longDescription'
export const elementContainerDelete_helpersFilePath = './ElementContainerDelete_helpers.js'
export const schemaUrl = 'http://schemas.pearson.com/wip-authoring/authoredtext/1#/definitions/authoredtext'
export const blockTextButtonText = 'block-text-button'
export const exifPixelXDimensionText = 'exif:pixelXDimension'
export const exifPixelYDimensionText = 'exif:pixelYDimension'
export const imageSchemaUrl = 'http://schemas.pearson.com/wip-authoring/image/1#/definitions/image'
export const hideFieldText = 'hide-field'
export const disableButttonText = 'disable-buttton'
export const spanMceCaretText = 'span#_mce_caret'
export const temp_WirisformulaClass = 'img.temp_Wirisformula'
export const elementBlockfeatureText = 'element-blockfeature'
export const elementDialogueText = 'element-dialogue'
export const imgHTML = "<img src='$1'></img>"
export const frontMatterText = 'Front Matter'
export const backMatterText = 'Back Matter'
export const elementLearningObjectiveMappingText = 'element-learningobjectivemapping'
export const elementListText = 'element-list'
export const shfTabEvntClass = 'li.shfTabEvnt'
export const lowerAlphaText = 'lower-alpha'
export const lowerRomanText = 'lower-roman'
export const upperAlphaText = 'upper-alpha'
export const toxTbtnEnabledClass = 'tox-tbtn--enabled'
export const showCrossRefLabelClass = 'show-cross-ref-label'
export const hideCrossRefLabelClass = 'hide-cross-ref-label'
export const nameAttrSelect = "[name='alt_text']"
export const nameAttrSelectLongDesc = "[name='long_description']"
export const pointerEventsNoneText = 'pointer-events-none'
export const primaryBlockcodeEquationText = 'primary-blockcode-equation'
export const sidebarDisableText = 'sidebar-disable'
export const imageTextWidthText = 'IMAGE_TEXT_WIDTH'
export const imageActualSizeText = 'IMAGE_ACTUAL_SIZE'
export const image50Text = 'IMAGE_50_TEXT'
export const imageWiderText = 'IMAGE_WIDER'
export const imageFullText = 'IMAGE_FULL'
export const longDescriptionText = 'Long Description'
export const imageElemText = 'image-elem'
export const assessmentElemText = 'assessment-elem'
export const workedExpElemText = 'worked-exp-elem'
export const sectionBreakElemText = 'section-break-elem'
export const paragraphNumeroUnoClass = ' class="paragraphNumeroUno"'
export const paragraphHTML = "<p><br></p>"
export const enterButtonLabelText = 'Enter Button Label'
export const spanSelectorBookmark = 'span[data-mce-type="bookmark"]'
export const WirisformulaClass = '.Wirisformula'
export const imageAssetContentClass = 'class="imageAssetContent'
export const cypressEditableClass = '.cypress-editable'
export const classWirisformula = 'class="Wirisformula'
export const classTempWirisformula = 'class="temp_Wirisformula'
export const classAnswerLineContent = 'class="answerLineContent'
export const placeHolderText = 'place-holder'
export const poetryLineClass = '.poetryLine'
export const EnterCharacterNameText = 'Enter Character Name...'
export const pearsonDomain = 'pearson.com'
export const externalLinkText = 'external-link'
export const markedindexCrossReferenceId = 'markedindex-cross-reference'
export const markedindex0Id = 'markedindex-0'
export const dataMathmlText = 'data-mathml'
