let config = {
    ...
    COMMON_API_ENDPOINT : process.env.NODE_ENV === "production" ? process.env.COMMON_API_ENDPOINT : "https://contentapis-staging.pearsoncms.net/",
    ...
    // AUDIO_NARRATION_URL : process.env.NODE_ENV === "production" ? process.env.AUDIO_NARRATION_URL : 'https://contentapis-staging.pearsoncms.net/structure-api/',
    ...
    ssoToken: "TpXAXerMbByhNH68Xs-7MGkKgH0.*AAJTSQACMDIAAlNLABxVQWZGbnFwamZSSHphZjNQMGlEVkdBM3JyUzQ9AAJTMQACMDE.*",
    alfrescoMetaData : {},
    ...
    assessmentSlateToolbar:['slatetag'],
