let config = {
    ...
    LEARNING_OBJECTIVES_ENDPOINT: process.env.NODE_ENV === "production" ? "" : "https://contentapis-staging.pearson.com/lo-api/",
    ASSET_POPOVER_ENDPOINT: process.env.NODE_ENV === "production" ? "https://contentapis.pearson.com/lo-api/" : "https://contentapis-staging.pearson.com/manifest-api/",
