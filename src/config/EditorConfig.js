...
export const EditorConfig = {
    ...
    toolbar: 'undo redo| bold italic underline strikethrough removeformat| alignleft aligncenter alignright alignjustify outdent indent customListButton bullist | superscript subscript charmap ',
