export const powerpaste_list_content_style = '.mce-content-body {-moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none; unselectable="on" onselectstart="return false;" onmousedown="return false; }' +
    ...
    'ol li, ul li {list-style-type: none !important; font-family: Georgia Pro, serif, Palatino, Palatino Linotype, Palatino LT STD !important; font-weight: normal; line-height: 1.90em; letter-spacing: 0.01em; margin-left: 0em !important; margin-bottom: .65em !important; color: black !important; font-size: 1em !important; } ' +
    ...
    'li.listItemNumeroUnoBullet {color: #000; font-family: Georgia Pro, serif, Palatino, Palatino Linotype, Palatino LT STD !important; font-size: 1.180em; font-weight: normal; line-height: 1.70em; letter-spacing: 0.01em; margin-top: 0em; margin-bottom: 0.5em; } ' +
