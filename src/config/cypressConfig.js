...
let cypressConfig = {
    ...
    getENVConfig: process.env.NODE_ENV === "development" ? `https://${ENV_NAME}-structuredauthoring.pearson.com/cypress/canvas-srvr/cypress-api/` : '/cypress/canvas-srvr/cypress-api/',
