...
export const prevIcon = (() => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="20" viewBox="0 0 12 20">
            <path fill="#005A70" d="M10.056 20c-.536 0-1.073-.133-1.475-.532L.536 11.495C.134 11.096 0 10.565 0 10.033c0-.531.268-1.063.536-1.462L8.581.598c.804-.797 2.011-.797 2.816 0 .804.797.804 1.993 0 2.79l-6.704 6.645 6.704 6.645c.804.797.804 1.993 0 2.79-.269.4-.805.532-1.341.532z" />
        </svg>
...
export const loNextIcon = (() => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="12" viewBox="0 0 20 20">
        <path fill="#00000" d="M1.944 20c.536 0 1.073-.133 1.475-.532l8.045-7.973c.402-.399.536-.93.536-1.462 0-.531-.268-1.063-.536-1.462L3.419.598c-.804-.797-2.011-.797-2.816 0-.804.797-.804 1.993 0 2.79l6.704 6.645-6.704 6.645c-.804.797-.804 1.993 0 2.79.269.4.805.532 1.341.532z"/>
    </svg>
...
export const editIcon = (() => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height="10" viewBox="2 2 20 20" width="10" fill="white">
            <path d="M0 0h24v24H0V0z" fill="none"></path><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM5.92 19H5v-.92l9.06-9.06.92.92L5.92 19zM20.71 5.63l-2.34-2.34c-.2-.2-.45-.29-.71-.29s-.51.1-.7.29l-1.83 1.83 3.75 3.75 1.83-1.83c.39-.39.39-1.02 0-1.41z">
            </path>
        </svg>
    )
})();
...
export const approvedIcon = (() => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
            <path id="path1" d="M0 0h24v24H0z" fill="none" />
            <path id="path2" d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" />
        </svg>
    )
})();
