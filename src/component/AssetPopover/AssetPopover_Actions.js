...
//      return store.dispatch({type : 'USE_STATE_IMAGE_DATA', payload : {
...
//     // let versionUrn = manifest_object['PROJECT_URN'];
//     let versionUrn = config.projectUrn;
...
//     .then(res => res.json())
//     .then(
//       data => dispatch({ type: 'IMAGES_FROM_API', payload: {
//         images : data.images,
//         searchTerm : searchTerm,
//         timeByAPI : performance.now()-time1
//       }}),
//       err => dispatch({ type: 'IMAGES_FROM_API_FAIL', payload: err })
...
export const searchForFiguresAction = (searchTerm, stateImageData) => {
  ...
  return store.dispatch({ type: 'IMAGES_FROM_API', payload: {
