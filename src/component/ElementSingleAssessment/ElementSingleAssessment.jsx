    ...
    render() {
        ...
        return (
            <div className="figureElement" onClick = {this.handleAssessmentFocus}>
                ...
                {this.state.showElmComponent? <RootElmSingleAssessment activeAssessmentType={this.state.elementType} closeElmWindow={() => this.closeElmWindow()} addPufFunction={this.addPufAssessment} activeUsageType={this.state.activeAssessmentUsageType} currentElement={this.props.model && this.props.model.figuredata && this.props.model.figuredata?this.props.model.figuredata:{} }/> : ''}
            </div>
        );
    }
}
