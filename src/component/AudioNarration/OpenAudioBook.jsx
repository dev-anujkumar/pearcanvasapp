...
class OpenAudioBook extends React.Component {
    ...
    handleClick = (e) => {
        ...
        //  this.props.closeAudioBookDialog(this)
    }
    ...
    render = () => {
        ...
        return (
            <div className="audiodropdown" ref={node => this.node = node}>
                <div style={{ padding: '15px' }}>
                    <h2 style={{ float: "left", color: '#3298B5' }}>Audio Book</h2>
                    <span onClick={(e) => { closeAudioBookDialog() }} style={{ cursor: "pointer", float: "right", color: "#000000", fontWeight: "bold" }}>{closeIcon}</span>
                </div>
                <figure>
