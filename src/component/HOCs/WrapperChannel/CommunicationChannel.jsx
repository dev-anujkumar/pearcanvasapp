        ...
        handleLOData=(message) =>{
            if (message.statusForSave) {
                ...
                if (message.toastData === "Learning Objectives has been unlinked ") {
                    slateTagClass[0].outerHTML = '<svg class="learning-objective" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 24 24"><g id="Artboard_1" data-name="Artboard – 1" clip-path="url(#clip-Artboard_1)"><rect width="24" height="24" fill="none"/><g id="baseline-label-24px"><path id="Path_1664" data-name="Path 1664" d="M17.63,5.84A1.994,1.994,0,0,0,16,5L5,5.01A2,2,0,0,0,3,7V17a2,2,0,0,0,2,1.99L16,19a1.994,1.994,0,0,0,1.63-.84L22,12,17.63,5.84Z" fill="#6e6e6e"/></g></g></svg>';
                }
                else {
