                ...
                case 'cancelCEPopup':
                    ...
                    if(message.hasOwnProperty('slateTagEnabled')){
                        ...
                        if (config.parentEntityUrn !== ("Front Matter" || "Back Matter")) {
                            ...
                            sendDataToIframe({ 'type': 'AssessmentSlateTagStatus', 'message': { assessmentId:  assessmentUrn, AssessmentSlateTagStatus : message.slateTagEnabled, containerUrn: slateManifestUrn } });
