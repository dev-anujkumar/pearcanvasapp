...
const ElementContainerHOC = (WrappedComponent) => {
    ...
    return class extends Component {
        ...
        renderContainer = (model, index, slateLockInfo) => {
            ...
            if(model.contents.hasOwnProperty(formattedTitleText)){
                /**
                 * New format
                 */
                formattedTitle = getTitleSubtitleModel(model.contents[formattedTitleText].html.text, formattedTitleText).replace(/&nbsp;/g, "")
                formattedSubtitle = getTitleSubtitleModel(model.contents[formattedTitleText].html.text, "formatted-subtitle")
            }
            else{
