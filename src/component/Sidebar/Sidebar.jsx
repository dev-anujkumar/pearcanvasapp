    ...
    */
    ...
    render = () => {
        return (
            ...
            {this.props.isTCMCanvasPopupLaunched && <PopUp isTCMCanvasPopup={true} dialogText={this.props.tcmSnapshotData.contentDifference} assessmentClass={'tcm-canvas-popup'} handleTCMRedirection={this.props.handleTCMRedirection}/>}
            </>
        );
    }
}
