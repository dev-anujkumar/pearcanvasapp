...
class Sidebar extends Component {
    ...
    */
    ...
    render = () => {
        return (
            <>
                {this.props.activeElement && Object.keys(this.props.activeElement).length !== 0 && this.props.activeElement.elementType !== "element-authoredtext" && this.props.activeElement.elementType !== 'discussion' && <div className={`canvas-sidebar ${this.props.isBannerVisible ? 'canvas-sidebar-banner' : ''}`}>
