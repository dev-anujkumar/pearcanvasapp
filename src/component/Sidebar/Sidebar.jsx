...
class Sidebar extends Component {
    ...
    toggleElementDropdown = e => {
        ...
        if(e.target.dataset && e.target.dataset.element !== "secondary"){
            let disabledPrimaryOption=["primary-openerelement", "primary-single-assessment" ,"primary-popup", "primary-showhide", "primary-mmi", "primary-smartlink","primary-citations-group", "primary-element-citation", "primary-poetry", "primary-stanza", "primary-editor-table-equation", "primary-blockcode-equation", "primary-mathml-equation"];
            ...
            if(this.state.activePrimaryOption === "primary-blockcode-equation" && this.props.activeElement.elementId){
                ...
                attributions = <div>
                    <div className="panel_show_module">
                        ...
                        <label className="switch"><input type="checkbox" checked={this.state.bceToggleValue ? this.state.bceToggleValue : true} onClick={ !hasReviewerRole() && this.handleBceToggle}/>
        ...
        if (tag === 'BCE') {
            return <div className="panel_syntax_highlighting">
                ...
                <label className="switch">
                    <input type="checkbox" checked={this.state.syntaxHighlightingToggleValue ? this.state.syntaxHighlightingToggleValue : true} onClick={!hasReviewerRole() && this.handleSyntaxHighlightingToggle} />
