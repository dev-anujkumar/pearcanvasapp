...
import { SYNTAX_HIGHLIGHTING,CHANGE_ASSESSMENT_TYPE, INTENDED_PLAYBACK_CATEGORY, SUB_CATEGORY, CATEGORY, MODAL_MESSAGE,
        ...
        outputTypeData,DIGITAL,PRINT, PDF_ASSESSMENT_AND_TCC_TYPE} from '../SlateWrapper/SlateWrapperConstants.js';
...
class Sidebar extends Component {
    ...
    handleOutputTypeValue = (e) => {
     ...
     outputTypeOption = () => {
        ...
        const { asideData,activeElement } = this.props;
         if (activeElementType === 'element-authoredtext' && asideData?.type !== 'manifestlist' && !(PDF_ASSESSMENT_AND_TCC_TYPE.includes(activeElement?.elementWipType))) {
             return (
                 <FormControl>
    ...
    */
    ...
    render = () => {
        ...
        return (
            <>
                {this.props.activeElement && Object.keys(this.props.activeElement).length !== 0 && this.props.activeElement.elementType !== 'discussion' && this.props.activeElement.primaryOption !== 'primary-tabbed-elem' && !(PDF_ASSESSMENT_AND_TCC_TYPE?.includes(activeElement?.elementWipType)) && <div className="canvas-sidebar">
