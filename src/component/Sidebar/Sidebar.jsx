    ...
    secondaryOption = () => {
        ...
        if(this.state.activeElementType){
            ...
            if(secondaryOptionList.length > 1 || enableColumn3SecondaryOption) {
                ...
                const pointerClass = hasReviewerRole() ? "pointer-events-none" : ''
                secondaryOptions = <div
                    ...
                    </div>) : (<div className={`element-dropdown-title bce ${disabled} ${pointerClass}`} data-element="secondary" onClick={enableColumn3SecondaryOption ? null : this.toggleElementDropdown}>
                        <Autocomplete
                            disablePortal
                            disableClearable
