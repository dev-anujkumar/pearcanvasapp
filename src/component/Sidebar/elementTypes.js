import { image50Text, imageActualSizeText, imageFullText, imageTextWidthText, imageWiderText, longDescriptionText } from "../../constants/Element_Constants";
...
export default {
        ...
        'primary-image-figure': {
            ...
            subtype: {
                'secondary-image-figure-width': {
                    text: 'Text Width',
                    labelText: 'Fg',
                    enum: imageTextWidthText
                },
                'secondary-image-figure-actual': {
                    text: 'Actual Size',
                    labelText: 'Fg',
                    enum: imageActualSizeText
                },
    ...
    'citations' : {
        'primary-citations-group': {
            text: 'Citation Group',
            enum: 'CITATION',
            toolbar: ['insertMedia','formatSelector','footnote', 'increaseindent', 'decreaseindent', 'glossary', 'crossLinkingIcon', 'assetpopover', 'orderedlist', 'unorderedlist','alignment', 'calloutIcon', 'IndexEntry'],
            subtype: {
