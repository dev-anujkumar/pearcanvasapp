...
export class TinyMceEditor extends Component {
    ...
    editorClick = (editor) => {
        editor.on('click', (e) => {
            ...
            if (e?.target?.nodeName == 'IMG' && e.target.classList.contains('imageAssetContent') && (e?.detail == 2) && (this?.props?.element?.type == 'element-list' || (this?.props?.element?.type === ElementConstants.AUTHORED_TEXT ))) {
                const imageArgs = {
    ...
    editorKeyup = (editor) => {
        editor.on('keyup', (e) => {
            ...
            let isAssetInsideBlockList = (activeElement.innerHTML && activeElement?.innerHTML?.match(/<img/)?.input.includes('class="imageAssetContent'));
            ...
            if (activeElement) {
                ...
                else if(isAssetInsideBlockList){
                    activeElement.classList.remove('place-holder')
                }
                else {
                    activeElement.classList.add('place-holder')
 ...
 */
    ...
    editorKeydown = (editor) => {
        editor.on('keydown', (e) => {
            ...
            if(isAssetInsideBlockList && blockListData && Object.keys(blockListData).length !== 0){
                activeElement.classList.remove('place-holder')
            }
