...
export const tcmSnapshotsMetadataField = (snapshotsData, defaultKeys, containerElement,type,index, calledFrom) => {
    ...
    elementId.childId = wipData.type === POPUP_ELEMENT ? wipData.popupdata[FORMATTED_TITLE] && wipData.popupdata[FORMATTED_TITLE].id : wipData.id;; // delete Whole pop case handling
