        ...
        if(context === 'video-mcq' || context === 'mcq' || context === "guided-example" ) {
            ...
            jsx = <div className={divImage} resource="">
                <figure className={figureImage} resource="">
                    ...
                    {element.figuredata.interactiveformat === ELM_INT && <div className={id+' mmi-elm-interactive-title'} onClick={(event) => this.handleClickElement(event)}><strong>{path ? path : 'INTERACTIVE TITLE: '} </strong>{this.state.interactiveTitle ? this.state.interactiveTitle : ""}</div>}
