    ...
    render(){
        ...
        return (
            ...
            className={
                ...
                {this.state.showCopyPopup && <CopyUrn inContainer={true} element={this.props.element} toggleCopyMenu={this.toggleCopyMenu} copyClickedX={this.copyClickedX} copyClickedY={this.copyClickedY} />}
