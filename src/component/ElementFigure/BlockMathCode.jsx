...
/**Import Constants */
import { BLOCK_CODE_DIV_CLASS, MATH_ML_DIV_CLASS, BLOCK_CODE_PLACEHOLDER, MATH_ML_PLACEHOLDER, BLOCK_CODE_TAG_NAME, MATH_ML_TAG_NAME, BLOCK_CODE_CLASS_NAME, MATH_ML_CLASS_NAME } from './ElementFigure_Constants'
...
const BlockMathCode = (props) => {
    ...
    let divClass = (elementType === 'codelisting' ? BLOCK_CODE_DIV_CLASS : MATH_ML_DIV_CLASS),
        placeHolder = (elementType === 'codelisting' ? BLOCK_CODE_PLACEHOLDER : MATH_ML_PLACEHOLDER),
        tagName = (elementType === 'codelisting' ? BLOCK_CODE_TAG_NAME : MATH_ML_TAG_NAME),
        tinyMceClass = (elementType === 'codelisting' ? BLOCK_CODE_CLASS_NAME : MATH_ML_CLASS_NAME),
        model = (elementType === 'codelisting' ? processedText : posterText);
