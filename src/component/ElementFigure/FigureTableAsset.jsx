            ...
            <div id="figure_add_div" className={`pearson-component image figureData ${props.model.figuredata.tableasHTML !== "" ? 'table-figure-data' : ""}`} data-type={dataType} >
                <div className="tableMediaWrapper">
                    ...
                    <div className="tableAssetWrapper">
                        {
                            props.model.figuretype === "tableasmarkup" && (props.model.figuredata.tableasHTML && (props.model.figuredata.tableasHTML !== "" ||
                            props.model.figuredata.tableasHTML !== undefined)) ?
                                ...
                                <div className="table-asset-wrapper-without-asset">
                                    ...
                                    <button className={`table-asset-button ${hasReviewerRole() ? 'pointer-events-none' : ''}`}
                                    onClick={!hasReviewerRole() && ((e) => props.addFigureResource(e))}>
