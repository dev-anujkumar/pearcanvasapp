...
export const assessmentType = ['Full Assessment CITE', 'Full Assessment TDX' , 'Full Assessment Elm' , 'Learning App Type', 'Full Assessment Learnosity']
...
export const LEARNOSITY = 'Full Assessment Learnosity'
