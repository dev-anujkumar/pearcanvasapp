      ...
      <div className="vex-overlay cite-wrapper">
        <div className="root-container">
            <CiteTdxHeader headerProps={this.headerProps} />
              ...
              <CiteTdxFooter openedFrom = {this.props.openedFrom} closeWindowAssessment={this.headerProps.closeWindowAssessment} addCiteTdxFunction={this.props.addCiteTdxFunction} usageTypeMetadata={this.props.usageTypeMetadata}/>
        </div>
      </div>
    );
  }
