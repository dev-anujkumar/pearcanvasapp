...
import { ERROR_MESSAGE_ELM_RESOURCE, ERROR_MESSAGE_ELM_ITEMS, ERROR_MESSAGE_LEARNOSITY, ERROR_MESSAGE_ELM_DEFAULT, PUF, LEARNOSITY_BETA, ERROR_MESSAGE_ELM_INTERACTIVES } from '../../../AssessmentSlateConstants.js'

const ElmError = (props) => {

    const getErrorMessage = () => {
        let errorMessage = '';
        if(props && (props.activeAssessmentType == 'elminteractive') && props.errFlag){
