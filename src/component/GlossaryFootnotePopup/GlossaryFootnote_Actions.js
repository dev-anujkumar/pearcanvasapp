...
import { elementAsideText, elementBlockfeatureText, elementDialogueText, formattedTitleText } from '../../constants/Element_Constants';
const elementTypeData = ['element-authoredtext', 'element-list', elementBlockfeatureText, 'element-learningobjectives', 'element-citation', 'stanza', 'figure'];
...
export const glossaaryFootnotePopup = (status, glossaaryFootnote, glossaryfootnoteid, elementWorkId, elementType, index,blockfeatureType, elementSubType, glossaryTermText, typeWithPopup, poetryField) => async (dispatch) => {
    ...
    if (status === true) {
        ...
        if (showHideElement || asideParent?.type === 'showhide' && (newBodymatter[tempIndex[0]]?.interactivedata?.[asideParent?.sectionType][tempIndex[2]]?.type!=='poetry') && elementType !== elementBlockfeatureText) { /** Glossary-Footnotes inside Show-Hide */
            ...
            if(tempIndex.length == 4 && glossaryFootElem[tempIndex[0]]?.type === "showhide" && elementType === elementBlockfeatureText){
                glossaryFootElem = newBodymatter[tempIndex[0]]?.interactivedata?.show[tempIndex[0]]
            }
        } else if ((tempIndex.length == 5 || tempIndex.length == 6) && elementType == 'figure' && asideParent?.type === elementAsideText && asideParent?.parent?.type === 'showhide') {
            ...
            if(tempIndex.length == 4 && elementType === elementBlockfeatureText && newBodymatter[updatedIndex].type == 'groupedcontent'){
                glossaryFootElem = newBodymatter[tempIndex[0]]?.groupeddata?.bodymatter[tempIndex[1]]?.groupdata?.bodymatter[tempIndex[2]]
            } else if((tempIndex.length == 3 || tempIndex.length == 4) && elementType === elementBlockfeatureText && newBodymatter[updatedIndex].type == elementAsideText){
                glossaryFootElem = newBodymatter[tempIndex[0]]?.elementdata?.bodymatter[tempIndex[0]]
            } else {
                glossaryFootElem = newBodymatter[updatedIndex]
            }
        } else if (elementType === elementBlockfeatureText && blockfeatureType !== "pullquote" ) {
            ...
            } else if (elementType === elementBlockfeatureText && newBodymatter[tempIndex[0]]?.type == 'groupedcontent') {
                let indexesLen = tempIndex.length;
                switch (indexesLen) {
                    case 4:
                        glossaryFootElem = newBodymatter[tempIndex[0]]?.groupeddata?.bodymatter[tempIndex[1]]?.groupdata?.bodymatter[tempIndex[2]]
            ...
            } else if (elementType === elementBlockfeatureText && newBodymatter[updatedIndex]?.type == elementAsideText) {
                let indexesLen = tempIndex.length;
                switch (indexesLen) {
                    case 3:
                        glossaryFootElem = newBodymatter[tempIndex[0]]?.elementdata?.bodymatter[tempIndex[1]]
            ...
            } else if (newBodymatter[tempIndex[0]]?.type === 'showhide' && elementType === elementBlockfeatureText) {
                let indexesLen = tempIndex.length;
                switch (indexesLen) {
                    case 4:
            ...
            switch (indexesLen){
                case 2:
                    glossaryFootElem = newBodymatter[tempIndex[0]].popupdata[formattedTitleText];
                    break;

                case 3:
                    glossaryFootElem = newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]].popupdata[formattedTitleText];
                    break;

                case 4:
                    glossaryFootElem = newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]].contents.bodymatter[tempIndex[2]].popupdata[formattedTitleText];
                    break;
                /*
                    footnote for popup title inside aside element inside multicolumn BG-4750
                */
               case 5:
                    glossaryFootElem = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].elementdata.bodymatter[tempIndex[3]].popupdata[formattedTitleText];
                    break;
                case 6: // TB->Tab->AS/WE->HEAD->Popup
                    if (newBodymatter[tempIndex[0]]?.type === ElementConstants.MULTI_COLUMN && newBodymatter[tempIndex[0]]?.subtype === ElementConstants.TAB) {
                        glossaryFootElem = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]].groupdata.bodymatter[tempIndex[3]].elementdata.bodymatter[tempIndex[4]].popupdata[formattedTitleText];
                    } else {  // Multicolumn->AS/WE->BODY->Popup
                        glossaryFootElem = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].elementdata.bodymatter[tempIndex[3]].contents.bodymatter[tempIndex[4]].popupdata[formattedTitleText];
                    }
                    break;
                case 7: // TB->Tab->AS/WE->BODY->Popup
                    glossaryFootElem = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]].groupdata.bodymatter[tempIndex[3]].elementdata.bodymatter[tempIndex[4]].contents.bodymatter[tempIndex[5]].popupdata[formattedTitleText];
                    break;
            }
        }
            ...
            if (indexesLen === 2) {
                switch (tempIndex[1]) {
                    case "1":
                        glossaryFootElem = newBodymatter[tempIndex[0]].contents[formattedTitleText] || {};
                        break;
                    // case "3":
                ...
                if(newBodymatter[tempIndex[0]]?.type == elementAsideText){
                    switch (tempIndex[2]) {
                        case "1":
                            glossaryFootElem = newBodymatter[tempIndex[0]]?.elementdata.bodymatter[tempIndex[1]]?.contents[formattedTitleText] || {}
                            break;
                        case "4":
                ...
                if(newBodymatter[tempIndex[0]]?.type == elementAsideText){
                    switch (tempIndex[3]) {
                        case "1":
                            glossaryFootElem = newBodymatter[tempIndex[0]]?.elementdata.bodymatter[tempIndex[1]]?.contents.bodymatter[tempIndex[2]]?.contents[formattedTitleText] || {}
                            break;
                        case "4":
                    ...
                    switch (tempIndex[3]) {
                        case "1":
                            glossaryFootElem = newBodymatter[tempIndex[0]]?.groupeddata.bodymatter[tempIndex[1]]?.groupdata.bodymatter[tempIndex[2]]?.contents[formattedTitleText] || {}
                            break;
                        case "4":
                    ...
                    switch (tempIndex[3]) {
                        case "1":
                            glossaryFootElem = newBodymatter[tempIndex[0]]?.interactivedata[asideParent?.sectionType][tempIndex[2]]?.contents[formattedTitleText] || {}
                            break;
                        case "4":
                ...
                switch (tempIndex[4]) {
                    case "1":
                        glossaryFootElem = (newBodymatter[tempIndex[0]]?.groupeddata.bodymatter[tempIndex[1]]?.groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]]?.groupdata.bodymatter[tempIndex[3]]?.contents[formattedTitleText] ? newBodymatter[tempIndex[0]]?.groupeddata.bodymatter[tempIndex[1]]?.groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]]?.groupdata.bodymatter[tempIndex[3]]?.contents[formattedTitleText] : { html: '' });
                        break;
                    case "4":
        ...
        } else if ((tempIndex.length >= 4 && tempIndex.length <= 7) && elementType === elementDialogueText && newBodymatter[tempIndex[0]].type === "groupedcontent") { // MultiColumn->PS or MultiColumn->As->PS or MultiColumn->WE->PS
            let elementInside2C = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]];
            if (elementInside2C.type === elementAsideText && elementInside2C.subtype === "sidebar") {
                glossaryFootElem = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].elementdata.bodymatter[tempIndex[3]];
            } else if (elementInside2C.type === elementAsideText && elementInside2C.subtype === "workedexample") {
                glossaryFootElem = newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].elementdata.bodymatter[tempIndex[3]];
        ...
        } else if ((tempIndex.length >= 5 && tempIndex.length <= 7) && elementType === elementDialogueText && asideParent?.parent?.type === 'showhide' && asideParent?.type === elementAsideText && asideParent?.parent?.showHideType) { // S/H->AS/WE->PS
        ...
        } else if (elementType === elementDialogueText && newBodymatter[tempIndex[0]].type === elementAsideText && newBodymatter[tempIndex[0]].subtype === "workedexample") { //Playscript inside we element
            glossaryFootElem = newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]];
            if (glossaryFootElem.type === 'manifest') {
                glossaryFootElem = glossaryFootElem.contents.bodymatter[tempIndex[2]];
            }
        } else if (elementType === elementDialogueText && newBodymatter[tempIndex[0]].type === elementAsideText && newBodymatter[tempIndex[0]].subtype === "sidebar") { //Playscript inside aside element
            glossaryFootElem = newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]];
        } else if (elementType === elementDialogueText) {
            ...
            if (typeof (index) == 'number') {
                ...
                if ((indexesLen == 4 || indexesLen == 5 || indexesLen == 7 || indexesLen == 9 ||indexesLen == 11) && newBodymatter[tempIndex[0]].type === "showhide" && asideParent?.parent?.showHideType) {
                    ...
                    if(elementType==='stanza'){
                        if(newBodymatter[indexes[0]]?.type == elementAsideText){
...
export const saveGlossaryAndFootnote = (elementWorkId, elementType, glossaryfootnoteid, type, term, definition, elementSubType, typeWithPopup, blockfeatureType, poetryField,audioGlossaryData,figureGlossaryData, indexEntries, crossReferences) => {
    ...
    else if(elementType == elementBlockfeatureText){
        ...
        switch (indexesLen){
            ...
            case 4:
                if(newBodymatter[elemIndex[0]]?.type == "groupedcontent"){ /* contentURN for PE title inside multicolumn element */
                    ...
                    parentEntityUrn = newBodymatter[elemIndex[0]]?.interactivedata[showhideTypeVal][elemIndex[2]]?.contents[formattedTitleText].contentUrn
                }
                else {
    ...
    return axios.put(url, JSON.stringify(data), {
        ...
        if (!isTbElement && !isBlockListElement) {
            if (elementTypeData.indexOf(elementType) !== -1 && typeWithPopup !== "poetry") {
                ...
                if ((showHideElement || asideParent?.type === 'showhide') && elementType !== elementBlockfeatureText) { /** Glossary-Footnotes inside Show-Hide */
        ...
        if (showHideElement || asideParent?.type === 'showhide'  && (newBodymatter[tempIndex[0]]?.interactivedata?.[asideParent?.sectionType][tempIndex[2]]?.type!=='poetry') && elementType !== elementBlockfeatureText) {/** Glossary-Footnotes inside Show-Hide */
            ...
            if(tempIndex.length == 4 && asideParent?.type === 'showhide' && elementType === elementBlockfeatureText){
            ...
            if(tempIndex.length === 4 && newBodymatter[updatedIndex].type === 'groupedcontent' && elementType === elementBlockfeatureText){
                newBodymatter[updatedIndex].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]] = res.data;
            } else if((tempIndex.length === 3 || tempIndex.length === 4) && newBodymatter[updatedIndex].type === elementAsideText){
                newBodymatter[updatedIndex].elementdata.bodymatter[tempIndex[1]] = res.data;
            } else if(tempIndex.length == 4 && newBodymatter[updatedIndex].type === 'showhide' && elementType === elementBlockfeatureText) {
                newBodymatter[tempIndex[0]].interactivedata.show[tempIndex[2]] = res.data;
            } else{
            ...
            } else if (newBodymatter[tempIndex[0]]?.type === 'groupedcontent' && elementType === elementBlockfeatureText) {
                let indexesLen = tempIndex.length;
                switch (indexesLen) {
                    case 4: {
                        newBodymatter[updatedIndex].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]] = res.data;
            ...
            } else if (newBodymatter[updatedIndex]?.type === elementAsideText) {
                let indexesLen = tempIndex.length;
                switch (indexesLen) {
                    case 3: {
                        newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]] = res.data;
            ...
            switch (indexesLen){
                case 2: {
                    ...
                    newBodymatter[tempIndex[0]].popupdata[formattedTitleText] = responseElement;
                    break;
                }
                case 3: {
                    ...
                    responseElement.html.text = createTitleSubtitleModel(titleHTML, responseElement.html.text)
                    newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]].popupdata[formattedTitleText] = responseElement;
                    break;
                }
                case 4: {
                    ...
                    responseElement.html.text = createTitleSubtitleModel(titleHTML, responseElement.html.text)
                    newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]].contents.bodymatter[tempIndex[2]].popupdata[formattedTitleText] = responseElement;
                    break;
                }
                ...
                case 5: {
                    ...
                    responseElement.html.text = createTitleSubtitleModel(titleHTML, responseElement.html.text)
                    newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].elementdata.bodymatter[tempIndex[3]].popupdata[formattedTitleText] = responseElement;
                    break;
                }
                case 6: { // TB->Tab->AS/WE->HEAD->Popup
                    ...
                    responseElement.html.text = createTitleSubtitleModel(titleHTML, responseElement.html.text);
                    if (newBodymatter[tempIndex[0]]?.type === ElementConstants.MULTI_COLUMN && newBodymatter[tempIndex[0]]?.subtype === ElementConstants.TAB) {
                        newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]].groupdata.bodymatter[tempIndex[3]].elementdata.bodymatter[tempIndex[4]].popupdata[formattedTitleText] = responseElement;
                    } else {  // Multicolumn->AS/WE->BODY->Popup
                        newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].elementdata.bodymatter[tempIndex[3]].contents.bodymatter[tempIndex[4]].popupdata[formattedTitleText] = responseElement;
                    }
                    break;
                }
                case 7: { // TB->Tab->AS/WE->BODY->Popup
                    ...
                    responseElement.html.text = createTitleSubtitleModel(titleHTML, responseElement.html.text);
                    newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]].groupdata.bodymatter[tempIndex[3]].elementdata.bodymatter[tempIndex[4]].contents.bodymatter[tempIndex[5]].popupdata[formattedTitleText] = responseElement;
                    break;
                }
            }
        }
            ...
            if (indexesLen === 2) {
                switch (tempIndex[1]) {
                    case "1":
                        ...
                        newBodymatter[tempIndex[0]].contents[formattedTitleText] = responseElement;
                        break;
                    // case "3":
                ...
                if(newBodymatter[tempIndex[0]]?.type == elementAsideText){ /* footnote for PE title inside WE/Aside element */
                    switch (tempIndex[2]) {
                        case "1":
                            let responseElement = {...res.data}
                            res.data.html.text = res.data.html.text.replace(/<p>|<\/p>/g, "")
                            responseElement.html.text = createTitleSubtitleModel("", res.data.html.text)
                            newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]].contents[formattedTitleText]= responseElement;
                            break;
                        case "4":
                ...
                if(newBodymatter[tempIndex[0]]?.type == elementAsideText){ /* footnote for PE title inside WE in section break element */
                    switch (tempIndex[3]) {
                        case "1":
                            let responseElement = {...res.data}
                            res.data.html.text = res.data.html.text.replace(/<p>|<\/p>/g, "")
                            responseElement.html.text = createTitleSubtitleModel("", res.data.html.text)
                            newBodymatter[tempIndex[0]].elementdata.bodymatter[tempIndex[1]].contents.bodymatter[tempIndex[2]].contents[formattedTitleText] = responseElement;
                            break;
                        case "4":
                    ...
                    switch (tempIndex[3]) {
                        case "1":
                            ...
                            res.data.html.text = res.data.html.text.replace(/<p>|<\/p>/g, "")
                            responseElement.html.text = createTitleSubtitleModel("", res.data.html.text)
                            newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[tempIndex[2]].contents[formattedTitleText] = responseElement;
                            break;
                        case "4":
                    ...
                    switch (tempIndex[3]) {
                        case "1":
                            ...
                            res.data.html.text = res.data.html.text.replace(/<p>|<\/p>/g, "")
                            responseElement.html.text = createTitleSubtitleModel("", res.data.html.text)
                            newBodymatter[tempIndex[0]].interactivedata[asideParent.sectionType][tempIndex[2]].contents[formattedTitleText] = responseElement;
                            break;
                        case "4":
                ...
                switch (tempIndex[4]) {
                    case "1":
                        ...
                        res.data.html.text = res.data.html.text.replace(/<p>|<\/p>/g, "")
                        responseElement.html.text = createTitleSubtitleModel("", res.data.html.text)
                        newBodymatter[tempIndex[0]].groupeddata.bodymatter[tempIndex[1]].groupdata.bodymatter[0].groupeddata.bodymatter[tempIndex[2]].groupdata.bodymatter[tempIndex[3]].contents[formattedTitleText] = responseElement;
                        break;
                    case "4":
            ...
            // S/H->AS/WE->PS
        } else if ((tempIndex.length >= 5 && tempIndex.length <= 7) && elementType === elementDialogueText && asideParent?.parent?.type === 'showhide' && asideParent?.type === elementAsideText && asideParent?.parent?.showHideType) {
            ...
            if (typeof (index) == 'number') {
                ...
                if ((indexesLen == 4 || indexesLen == 5 || indexesLen == 7 || indexesLen == 9 ||indexesLen == 11) && newBodymatter[indexes[0]].type === "showhide" && asideParent?.parent?.showHideType) {  // to support glossary in text elements inside WE/AS of S/H
                   ...
                   if(elementType==='stanza'){
                    ...
                    if(elementType && elementType==='stanza'){
                        if(newBodymatter[indexes[0]] && newBodymatter[indexes[0]].type == elementAsideText){
        ...
        if(currentPopupSlateData && currentPopupSlateData.type==="popup" && newPopupSlateData && newPopupSlateData.status === 'approved' && config.glossaryCreated){
            ...
            sendDataToIframe({ 'type': 'sendMessageForVersioning', 'message': 'updateSlate' });
        } else if(currentSlateData && currentSlateData.status === "approved" && (currentApprovedSlate && (currentApprovedSlate.type === "groupedcontent" || currentApprovedSlate.type === elementAsideText))){
            store.dispatch({
                type: UPDATE_FOOTNOTEGLOSSARY,
                payload: {
                    slateLevelData: newPopupParentData
...
export const UpdateElementWorkId = () => {
    ...
    } else if ((tempIndex.length == 5 || tempIndex.length == 6) && asideParent?.type === elementAsideText && asideParent?.parent?.type === 'showhide') {
