...
import { ShowLoader, SplitCurrentSlate, OpenLOPopup, WarningPopupAction, AddEditLearningObjectiveDropdown, HideLoader } from '../../constants/IFrameMessageTypes.js';
    ...
    splithandlerfunction = async(type, index, firstOne, parentUrn, asideData, outerAsideIndex ,poetryData) => {
        ...
        switch (type) {
            ...
            case 'worked-exp-elem':
                for(let index = 0; index < elementCount; index++) {
                await this.props.createElement(WORKED_EXAMPLE, indexToinsert, parentUrn, asideData, null, null, null)
                indexToinsert++
                }
                break;
            case 'opener-elem':
