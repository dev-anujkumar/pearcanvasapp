...
import {TEXT, IMAGE, VIDEO, ASSESSMENT, INTERACTIVE, CONTAINER, WORKED_EXAMPLE, SECTION_BREAK, METADATA_ANCHOR, LO_LIST, SLATE_ASSESSMENT, OPENER}from './SlateWrapperConstants';
        ...
        if (_slateData !== null && _slateData !== undefined) {
            if (Object.values(_slateData).length > 0 && config.slateType !== 'assessment') {
                ...
                if (_slateBodyMatter.length == 0 ) {
                 ...
                 sendDataToIframe({'type': ShowLoader,'message': { status: true }});
                 this.props.createElement(SLATE_ASSESSMENT, "0");
             }
        }
    }
