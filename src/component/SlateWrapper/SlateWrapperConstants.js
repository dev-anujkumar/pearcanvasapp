...
export const ERROR_CREATING_GLOSSARY = "You can not apply Glossary in multiple line of stanza!!!"
export const ERROR_CREATING_ASSETPOPOVER = "You can not apply Asset PopOver in multiple line of stanza!!!"