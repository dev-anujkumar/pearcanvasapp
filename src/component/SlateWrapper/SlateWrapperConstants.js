...
export const SPLIT_SLATE_WITH_ADDED_AUDIO = `There is an audio file linked with this slate. If you want to split the slate, you will need to re-do the
 narrative audio file for this slate and the newly generated split slate. Do you want to proceed with Split action?`
...
export const ERROR_DELETING_MANIFEST_LIST_ITEM= `The list item can not be deleted if it contains a child Block List.
 Please delete the child Block List to complete the delete action.`;
...
export const APPROVE_OWNER_SLATE= `The slate is currently in approved status (published title). Any change to this content will apply to all its children (subscribed titles).
 Do you want to move it to Work in Progress status in order to make a change?`
...
export const SET_AS_DECORATIVE_IMAGE_AUTONUM =
"Changing the image type will reset the following image data: label & number settings, label value, number, preview, title, caption, alt text and long description."
export const SET_AS_DECORATIVE_IMAGE_NON_AUTONUM =
"Changing the image type will reset the following image data: label value, number, title, caption, alt text and long description."
...
export const elementType = ['ASSESSMENT', 'ELEMENT_ASSESSMENT','WORKED_EXAMPLE', 'CONTAINER', 'SECTION_BREAK',
'TEXT', 'CITATION', 'ELEMENT_CITATION', 'POETRY', 'STANZA' , 'MULTI_COLUMN', 'MULTI_COLUMN_3C','POP_UP', "IMAGE", "VIDEO", "AUDIO",
"MATH_ML_CHEM_EDITOR", "BLOCK_CODE_EDITOR", "INTERACTIVE", "MMI_ELM", "SMART_LINK", "SHOW_HIDE", "ELEMENT_PDF", "MANIFEST_LIST"];
...
export const IMPORT_BANNER_MESSAGE = "Word Import is in progress by "
...
export const WORD_FILE_IMPORTED_TOAST_MESSAGE = 'Conversion on slate is completed.'
