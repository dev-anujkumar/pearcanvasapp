...
it('Test Function----->setCurrentSlate - Slate in Bodymatter',()=>{
    ...
    const spyFunction = jest.spyOn(actions,'setCurrentSlate');
    let dispatch = (obj) => {
        expect(obj.type).toBe('SET_CURRENT_SLATE_DATA')
    }
    actions.setCurrentSlate(returnAllSlateData)(dispatch)
    expect(spyFunction).toHaveBeenCalled()
})
it('Test Function----->setCurrentSlate - Slate in Frontmatter',()=>{
...
it('Test Function----->setCurrentSlate - Slate in Backmatter',()=>{
