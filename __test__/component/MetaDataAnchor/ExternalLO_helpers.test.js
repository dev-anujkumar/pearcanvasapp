...
describe("-----------------Testing ExternalLO_helpers-----------------", () => {
  describe("Test-1----------------- getMetadataAnchorLORef-----------------", () => {
    it("Test-1.1---getMetadataAnchorLORef - on Popup Slate", () => {
      config.tempSlateManifestURN =
        "urn:pearson:manifest:3894919a-4206-4f95-ac3e-3c2d9352e7c8";
        ...
        return {
          appStore: {
            slateLevelData: {
              ...
              ...testData.slateLevelData_1_PopupSlate,
            },
          },
          metadataReducer: {
      ...
      let result = externalLO_actions.getMetadataAnchorLORef()(
        dispatch,
        getState
      );
      ...
      let expectedResult = [
        {
          ...
          metaDataAnchorID: [
            "urn:pearson:work:f5beefb3-0042-4eba-a799-1af59546fa30",
          ],
          elementVersionType: "element-learningobjectivemapping",
          loIndex: [1],
        },
  ...
  describe("Test-3----------------- setCurrentSlateLOs-----------------", () => {
    it("Test-3.1---setCurrentSlateLOs", () => {
      ...
      let result = externalLO_actions.setCurrentSlateLOs(
        existingSlateLOs,
        unlinkedLOs,
        linkedLOs
      );
