...
jest.mock('../../../src/component/OpenerElement/OpenerConstants', () => ({
    ...
    labelOptions: ["No Label", "Chapter", "Ch", "Lesson", "Part", "Unit", "Workshop"],
    moduleLabelOptions: ["No Label", "Module" ,"Lesson Part" ,"Chapter", "Ch", "Lesson", "Part", "Unit", "Workshop"],
    volumeLabelOptions: ["No Label", "Volume", "Year", "Module" , "Lesson Part" , "Chapter", "Ch", "Lesson", "Part", "Unit", "Workshop"]
...
describe('Testing Opener component with props', () => {
    ...
    it('Simulating click event to open label dropdown : module', () => {
        const openerComponent = mount( <Provider store={store1}><OpenerElement {...props} /></Provider> )
        const OpenerInstance = openerComponent.find('OpenerElement').instance()
        openerComponent.find('div.element-dropdown-title.label-content').simulate('click');
        expect(OpenerInstance.state.showLabelDropdown).toBe(true)
        openerComponent.find('ul.element-dropdown-content>li:first-child').simulate('click');
    ...
    it('Simulating click event to open label dropdown : volume', () => {
        const openerComponent = mount( <Provider store={store2}><OpenerElement {...props} /></Provider> )
        const OpenerInstance = openerComponent.find('OpenerElement').instance()
        openerComponent.find('div.element-dropdown-title.label-content').simulate('click');
        expect(OpenerInstance.state.showLabelDropdown).toBe(true)
        openerComponent.find('ul.element-dropdown-content>li:first-child').simulate('click');
