...
import { updateBL, updateBL_IN_2C_3C, updateBL_IN_AS, updateBL_IN_SH, updateBL_IN_WE } from "../../../fixtures/slateTestingData"
...
describe('Testing ListButtonDropPortal component', () => {
    ...
    it("Test - getListDropPopUpState - element-aside - manifest : else", () => {
        const spygetListDropPopUpState = jest.spyOn(ListButtonDropPortalInstance, 'getListDropPopUpState')
        const slateData = {
            "urn:pearson:manifest:d9023151-3417-4482-8175-fc965466220e": {
                contents: {
    ...
    it("Test - getListDropPopUpState - element-aside - manifest - showhide : else", () => {
        const spygetListDropPopUpState = jest.spyOn(ListButtonDropPortalInstance, 'getListDropPopUpState')
        const slateData = {
            "urn:pearson:manifest:d9023151-3417-4482-8175-fc965466220e": {
                contents: {
    ...
    it("Test - getListDropPopUpState - groupedcontent - element-aside - manifest - else", () => {
        const spygetListDropPopUpState = jest.spyOn(ListButtonDropPortalInstance, 'getListDropPopUpState')
        const slateData = {
            "urn:pearson:manifest:d9023151-3417-4482-8175-fc965466220e": {
                contents: {
    ...
    it("Test - getListDropPopUpState - groupedcontent - element-aside - manifest - showhide : else", () => {
        const spygetListDropPopUpState = jest.spyOn(ListButtonDropPortalInstance, 'getListDropPopUpState')
        const slateData = {
            "urn:pearson:manifest:d9023151-3417-4482-8175-fc965466220e": {
                contents: {
    ...
    it("Test - getListDropPopUpState - groupedcontent - element-aside - manifest - showhide", () => {
        ...
        const activeElement = {
            elementWipType: 'element-list',
            elementId: 'urn:pearson:work:dcfbfd07-a00e-4497-bfe8-7a5c2824cb72',
            index: "1-0-0-0-0-1"
        }
        ListButtonDropPortalInstance.getListDropPopUpState(slateData, activeElement);
        expect(spygetListDropPopUpState).toHaveBeenCalled();
    ...
    it("Test - getListDropPopUpState - groupedcontent - else", () => {
        const spygetListDropPopUpState = jest.spyOn(ListButtonDropPortalInstance, 'getListDropPopUpState')
        const slateData = {
            "urn:pearson:manifest:d9023151-3417-4482-8175-fc965466220e": {
                contents: {
    ...
    it("Test - getListDropPopUpState - else", () => {
        const spygetListDropPopUpState = jest.spyOn(ListButtonDropPortalInstance, 'getListDropPopUpState')
        const slateData = {
            "urn:pearson:manifest:d9023151-3417-4482-8175-fc965466220e": {
                contents: {
    ...
    it('Test - getBlockListMetaData - BL in 2C/3C', () => {
        let props2 = {
            children: jest.fn(),
            slateData: updateBL_IN_2C_3C.slateLevelData
        }
        config.slateManifestURN = "urn:pearson:manifest:e5042835-1c9c-485d-ac89-c96a9a86473f";
        const portalElemParent = document.createElement('div');
        const portalElemChild = document.createElement('div');
        ...
        portalElemParent.appendChild(portalElemChild);
        document.body.appendChild(portalElemParent);
        const wrapper = mount(<Provider store={store3}> <ListButtonDropPortal {...props2} /></Provider>)
        const ListButtonDropPortalInstance = wrapper.find('ListButtonDropPortal').instance();
        const spygetBlockListMetaData = jest.spyOn(ListButtonDropPortalInstance, 'getBlockListMetaData')
        const elementData = {
            "listdata": {
