...
describe('Tests marked index action', () => {
   ...
   xit('should test marked index in para', async() => {
    ...
    xit('should test marked index in 2C ', async() => {
   ...
   xit('should test marked index in aside ', async() => {
    ...
    xit('should test marked index in aside of 2C', async() => {
