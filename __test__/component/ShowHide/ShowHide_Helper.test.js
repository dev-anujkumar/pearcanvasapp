...
describe('1. ShowHide test cases', () => {
    ...
    describe('1.4 - test cases for add elements in showHide', () => {
        ...
        const elementList = ["TEXT","IMAGE","VIDEO","figure-mml-elem","blockcode-elem","element-dialogue","smartlink-elem","element-discussion","elm-interactive-elem","interactive-elem","container-elem","citations-group-elem","poetry-elem","blocklist-elem"];
    ...
    describe("test handleElementsInShowHide", () => {
        ...
        describe('getTextElementInShowHide case 5:', () => {
